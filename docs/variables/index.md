...
| `process_heat_useful_energy_production` | Process heat useful energy production by technology | [`Heat production technologies`](/instructions-data/docs/variables/dimensions/tech_heat) |
| `space_heat_useful_energy_supply` | Space heat useful energy production by technology | [`Heat production technologies`](/instructions-data/docs/variables/dimensions/tech_heat) |
| `district_heat_useful_energy_production` | District heat useful energy production by technology | [`Heat production technologies`](/instructions-data/docs/variables/dimensions/tech_heat) |
